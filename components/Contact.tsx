...
//         <div className='flex flex-row pl-10 flex-wrap w-full px-5'>

//           {/* Contact Information Section */}
//           <div className='flex flex-col pr-[200px] pb-5 w-full md:w-auto'>
//             <h2 className='text-4xl font-bold text-white font-chillax'>Contact</h2>
//             <hr className='w-[30vh] bg-white mb-1 pt-1' />
...
//                 required
//               ></textarea>
//               <button className='bg-blue rounded-md p-2 flex items-center text-white justify-center w-[20vh]  active:scale-[.98] hover:scale-[1.01] ease-in-out transition-all' type="submit">
//                 Submit
//               </button>
//             </form>
//           </div>
//         </div>
//       </div>
//       <div className='bg-white flex text-center h-5'>
//         <p className='text-sm font-semibold'>
//           © 2024 Leroy Gutu - All Rights Reserved
//         </p>
//       </div>
//     </div>
//   );
